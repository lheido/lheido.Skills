...
public class SkillStaminaXInteraction extends SimpleInstantInteraction {

    public static final BuilderCodec<SkillStaminaXInteraction> CODEC =
        BuilderCodec.builder(
            SkillStaminaXInteraction.class,
            SkillStaminaXInteraction::new,
    ...
    protected void firstRun(
        ...
        StaminaSkillComponent upgradedComponent = StaminaSkillComponent.createLevelX();

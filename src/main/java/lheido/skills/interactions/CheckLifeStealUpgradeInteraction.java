...
/**
 * Interaction to check the upgrade prerequisites for the LifeSteal skill.
 * Configurable via JSON with RequiredLevel and TargetLevel.
 *
 * - RequiredLevel: The minimum required level (0 = no prerequisite, for LifeSteal A)
    ...
    extends SimpleInstantInteraction
{
    ...
    protected void firstRun(
        ...
        // Get the existing LifeSteal component (may be null)

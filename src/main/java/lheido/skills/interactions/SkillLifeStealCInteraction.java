...
/**
 * Interaction pour upgrader le skill LifeSteal vers le niveau C.
 * Requiert que le joueur possède déjà le skill LifeSteal niveau B.
 * Améliore le vol de vie (15% au lieu de 10%).
 */
public class SkillLifeStealCInteraction extends SimpleInstantInteraction {
    ...
    protected void firstRun(
        ...
        LifeStealSkillComponent upgradedComponent = LifeStealSkillComponent.createLevelC();
        ...
        player.sendMessage(
            Message.raw("Life Steal skill upgraded to level 3! You recover 15% of damage dealt as health.")
        );
    }
}

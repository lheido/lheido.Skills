    ...
    protected void firstRun(
        ...
        if (commandBuffer == null) {
            ...
            LOGGER.atWarning().log(
                "SkillStaminaBInteraction: CommandBuffer is null"
            );
            return;
        }
        ...
        if (player == null) {
            interactionContext.getState().state = InteractionState.Failed;
            LOGGER.atWarning().log("SkillStaminaBInteraction: Player is null");
            return;
        }
        ...
        LOGGER.atInfo().log("Player upgraded Stamina skill to level B");
    }
}

    ...
    protected void firstRun(
        ...
        if (commandBuffer == null) {
            ...
            LOGGER.atWarning().log(
                "SkillWaterBreathingCInteraction: CommandBuffer is null"
            );
            return;
        }
        ...
        if (player == null) {
            interactionContext.getState().state = InteractionState.Failed;
            LOGGER.atWarning().log("SkillWaterBreathingCInteraction: Player is null");
            return;
        }
        ...
        LOGGER.atInfo().log("Player upgraded Water Breathing skill to level C");
    }
}

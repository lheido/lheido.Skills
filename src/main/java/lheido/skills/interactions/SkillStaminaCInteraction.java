    ...
    protected void firstRun(
        ...
        if (commandBuffer == null) {
            ...
            LOGGER.atWarning().log(
                "SkillStaminaCInteraction: CommandBuffer is null"
            );
            return;
        }
        ...
        if (player == null) {
            interactionContext.getState().state = InteractionState.Failed;
            LOGGER.atWarning().log("SkillStaminaCInteraction: Player is null");
            return;
        }
        ...
        LOGGER.atInfo().log("Player upgraded Stamina skill to level C");
    }
}
